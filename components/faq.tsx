...
export function FAQ() {
  const faqs = [
    ...
    { question: "What is the difference between $UCC and FUD?", answer: "$UCC is our native utility token, while FUD represents governance rights in the Universe ecosystem." },
    { question: "Where to buy $UCC token?", answer: "$UCC tokens are available on major decentralized exchanges and our official platform." },
    { question: "Can I send my $UCC tokens to my ETH wallet like Metamask?", answer: "Yes, $UCC tokens are ERC-20 compatible and can be stored in any Ethereum wallet." },
